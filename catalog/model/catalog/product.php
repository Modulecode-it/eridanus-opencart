...
class ModelCatalogProduct extends Model {
        ...
        public function getProduct($product_id) {
                ...
                if ($query->num_rows) {
			$query2 = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_description WHERE product_id = " . $query->row['product_id']);
                        return array(
                                'product_id'       => $query->row['product_id'],
                                'name'             => $query->row['name'],
                                'description'      => $query2->row['description'],
                                'header'      => $query2->row['header'],
                                'short_description'      => $query2->row['short_description'],
                                'meta_title'       => $query2->row['meta_title'],
                                'meta_description' => $query2->row['meta_description'],
                                'meta_keyword'     => $query2->row['meta_keyword'],
                                'tag'              => $query2->row['tag'],
