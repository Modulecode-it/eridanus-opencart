...
Мой email: ' . $this->request->post['email'] . '
Мой IP: ' . $_SERVER['REMOTE_ADDR']);
			$mail->send();
	...
	protected function validate() {
		...
		if (!filter_var($this->request->post['email'], FILTER_VALIDATE_EMAIL)) {
			...
			$mail = explode('@',$this->request->post['email']);
			if ($mail[1]=='eridanus.ru') $this->error['email'] = $this->language->get('error_email');
		}
