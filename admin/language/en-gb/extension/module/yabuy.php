<?php
// Heading 
$_["heading_title"]  = 'Яндекс.Маркет FBS - прием заказов по API'; 
...
$_["text_module_type"] = "Яндекс-тип доставки";
...
$_["text_success"]	= 'Модуль `Яндекс.Маркет - прием заказов по API` успешно обновлен!';
...
$_["entry_oauth_token"]  = 'Токен oAuth:';
...
$_["entry_order_status_id"] = "Статус заказа, поступившего с Яндекс.Маркет";
$_["entry_payed_status_id"] = "Статус оплаченного заказа с Яндекс.Маркет";

$_["button_add"]  = "Добавить";
$_["button_remove"]  = "Удалить";

// Error
$_["error_permission"]    = 'У Вас нет прав для изменения модуля `Яндекс.Маркет - прием заказов по API`!';
