<?php
// Heading
$_['heading_title']           = 'Антиспам формы обратной связи и антирегистрация ботов, v2.0.2';
...
$_['entry_registr_status']    = 'Статус (антирегистрация ботов)';
...
$_['help_log']                = 'Журнал запросов от формы обратной связи сохраняется в файле "%s"';
$_['help_registr_log']        = 'Журнал запросов от формы регистрации сохраняется в файле "%s"';
