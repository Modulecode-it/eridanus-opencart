...
class ControllerDwebExporterDwebExporter extends Controller
{
    ...
    public function add()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm())
        {
            ...
            $this->response->redirect($this->url->link('dwebexporter/dwebexporter', 'user_token=' . $this->session->data['user_token'], true));
        }
    ...
    public function edit()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm())
        {
            ...
            $this->response->redirect($this->url->link('dwebexporter/dwebexporter', 'user_token=' . $this->session->data['user_token'] . $url, true));
        }
    ...
    protected function getList()
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('dwebexporter/dwebexporter', 'user_token=' . $this->session->data['user_token'] . $url, true)
        );

        $data['add'] = $this->url->link('dwebexporter/dwebexporter/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
        $data['delete'] = $this->url->link('dwebexporter/dwebexporter/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
        ...
        foreach ($results as $result)
        {
            ...
            $data['exportings'][] = array(
                ...
                'edit' => $this->url->link('dwebexporter/dwebexporter/edit', 'user_token=' . $this->session->data['user_token'] . '&id=' . $result['id'] . $url, true)
            );
        }
        ...
        $pagination->url = $this->url->link('dwebexporter/dwebexporter', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
    ...
    protected function getForm()
    {
        ...
        {
            $data['action'] = $this->url->link('dwebexporter/dwebexporter/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
        }
        else
        {
            $data['action'] = $this->url->link('dwebexporter/dwebexporter/edit', 'user_token=' . $this->session->data['user_token'] . '&id=' . $this->request->get['id'] . $url, true);
        }

        $data['cancel'] = $this->url->link('dwebexporter/dwebexporter', 'user_token=' . $this->session->data['user_token'] . $url, true);
