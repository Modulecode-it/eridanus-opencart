...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['needyml'])) {
			$data['needyml'] = $this->request->post['needyml'];
		} elseif (!empty($product_info)) {
			$data['needyml'] = $product_info['needyml'];
		} else {
			$data['needyml'] = '';
		}
		...
		if (isset($this->request->post['shippingtime'])) {
			$data['shippingtime'] = $this->request->post['shippingtime'];
		} elseif (!empty($product_info)) {
			$data['shippingtime'] = $product_info['shippingtime'];
		} else {
			$data['shippingtime'] = 1;
		}
