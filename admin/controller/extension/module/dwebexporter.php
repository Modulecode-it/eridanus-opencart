...
class ControllerExtensionModuleDwebExporter extends Controller
{
    ...
    public function index()
    {
        ...
        {
            $this->model_setting_setting->editSetting('module_dwebexporter', $this->request->post);
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/dwebexporter', 'user_token=' . $this->session->data['user_token'], true)
        );

        $data['action'] = $this->url->link('extension/module/dwebexporter', 'user_token=' . $this->session->data['user_token'], true);

        $data['cancel'] = $this->url->link('marketplace/extension', 'user_token=' . $this->session->data['user_token'] . '&type=module', true);

        if (isset($this->request->post['module_dwebexporter_status'])) {
            $data['module_dwebexporter_status'] = $this->request->post['module_dwebexporter_status'];
        } else {
            $data['module_dwebexporter_status'] = $this->config->get('module_dwebexporter_status');
        }
